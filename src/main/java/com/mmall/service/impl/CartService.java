...
public class CartService {
    ...
    public ServerResponse delete(Integer userid, String productIds){
        ...
        int i = cartMapper.deleteByProductIds(userid, productList);
        if(i == 0) {
            return ServerResponse.createByErrorMessage("操作失败");
        }else {
            return list(userid);
        ...
        if (CollectionUtils.isNotEmpty(cartList)) {
            for (Cart cartItem : cartList) {
                ...
                if (cartItem.getChecked() == Const.Cart.CHECKED) {
                    //如果已经勾选,增加到整个的购物车总价中
                    cartTotalPrice = BigDecimalUtil.add(cartTotalPrice.doubleValue(), cartProductVo.getProductTotlePrice().doubleValue());
                }
